...
/**
 * @title
 * @description 日水情录入日导入
 * @author bigb
 * @updateTime 2021/9/29 12:33
 * @throws
 */
@Slf4j
public class WrDayInputInDayListener extends AnalysisEventListener<Object> {

    /**
     * 私有构造函数
     */
    private WrDayInputInDayListener(){
     ...
     * excel所有数据
     */
    private List<WrDayInputInDayModel> modelList = new ArrayList<>();
    ...
    public static WrDayInputInDayListener getInstance(){
        return new WrDayInputInDayListener();
    }
     ...
     * @return
     */
    public List<WrDayInputInDayModel> getParseResult(){
        //线程阻塞,直至文件读取完成
    ...
    public void invoke(Object data, AnalysisContext context) {
        ...
        if (data instanceof LinkedHashMap) {
            WrDayInputInDayModel target = new WrDayInputInDayModel();
