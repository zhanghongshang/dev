 ...
 */
@Data
@TableName(value = "WR_DINW_S",schema = "USER_WR")
public class WrDinwS implements Serializable {
     ...
     * 月校核人登录名
     */
    @TableField("CHECKERCD")
    private String checkercd;

    /**
     * 月结算上报状态：N:未结算上报；Y:已结算上报，数据不能修改
     */
    @TableField("CLEAR")
     ...
     */
    @TableField("FWQTCK")
    private Double fwqtck;

    /**
     * 用于断面考核的取退水口水量，处理公摊系数<1的情况
     */
    @TableField("FWQTDMKH")
